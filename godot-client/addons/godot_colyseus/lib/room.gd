...
var frame_runner: ColyseusFrameRunner
...
var on_error: ColyseusEventListener = ColyseusEventListener.new()

# []
var on_leave: ColyseusEventListener = ColyseusEventListener.new()

# []
var on_join: ColyseusEventListener = ColyseusEventListener.new()

# [state: Schema]
var on_state_change: ColyseusEventListener = ColyseusEventListener.new()

# [data]
var _messages = {}
func on_message(event: String, new_listener: bool = true) -> ColyseusEventListener:
	var listener
	if not _messages.has(event) or new_listener:
		listener = ColyseusEventListener.new()
...
func _init(room_name: String,schema_type: GDScript):
	...
	frame_runner = ColyseusFrameRunner.new(_on_frame)
...
var state : ColyseusSchema : get = get_state
func get_state() -> ColyseusSchema:
